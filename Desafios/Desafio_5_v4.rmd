...
```{r, echo=F}
knitr::opts_chunk$set(echo = F, eval=T, highlight=T, warning=F, message=F, include=F)
```
...
[Respostas Sugeridas para Desafio 5 aqui](Desafio_5_v4_Suggested_Responses.html)
